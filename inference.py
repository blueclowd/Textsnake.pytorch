...
def inference(detector, test_loader, output_dir):
    ...
    for i, (image, meta) in enumerate(test_loader):
        ...
        path = os.path.join(cfg.vis_dir, '{}'.format(cfg.exp_name), meta['image_id'][idx])
...
def main():
    ...
    model_path = os.path.join(cfg.save_dir, cfg.exp_name, 'textsnake_{}_{}.pth'.format(model.backbone_name, cfg.checkepoch))
...
if __name__ == "__main__":
    ...
    vis_dir = os.path.join(cfg.vis_dir, '{}'.format(cfg.exp_name))
